...
import { UsersRound, Plus, MoreHorizontal, Shield, Mail, Phone, Search } from "lucide-react";
...
const mockTeam = [
  ...
  { id: 2, name: "Carla Souza", role: "Gerente de Vendas", email: "carla@conecta.com", status: "offline", avatar: "CS" },
